...
namespace PH.DataTree {
    ...
    public class DTreeNode<T> {
        #region Events
        public delegate void NodesAccessedInitiallyHandler(DTreeNode<T> parentNode, ref DTreeNodeCollection<T> nodesCollection);
        public event NodesAccessedInitiallyHandler NodesAccessedInitially = delegate(DTreeNode<T> parentNode, ref DTreeNodeCollection<T> nodesCollection) { };
        #endregion
        ...
        public DTreeNodeCollection<T> Nodes {
            get {
                if (mNodes == null) {
                    ...
                    NodesAccessedInitially(this, ref mNodes);
                }
                return mNodes;
            }
        }

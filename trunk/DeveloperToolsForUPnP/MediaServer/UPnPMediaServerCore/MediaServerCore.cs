...
namespace UPnPMediaServerCore
{
	...
	/// </summary>
	public sealed class MediaServerCore : IUPnPDevice
	{ 
...
//				}
	...
	*/
	...
	public class UPnPMediaServer : MarshalByRefObject, IUPnPDevice
	{
        public UPnPDevice GetUPnPDevice() {
            return MediaServerCore.serverCore.GetUPnPDevice();
        }

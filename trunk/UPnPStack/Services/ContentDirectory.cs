    ...
    public class ContentDirectory : IUPnPService
    {
        ...
        private class _DvContentDirectory
        {
            ...
            protected UPnPService BuildUPnPService()
            {
                ...
                RetVal[2] = new UPnPModeratedStateVariable("A_ARG_TYPE_Filter", typeof(System.String), false);
                RetVal[2].AddAssociation("Browse", "Filter");
                RetVal[2].AddAssociation("Search", "Filter");
                RetVal[3] = new UPnPModeratedStateVariable("SearchCapabilities", typeof(System.String), false);
                RetVal[3].AddAssociation("GetSearchCapabilities", "SearchCaps");
                ...
                RetVal[5] = new UPnPModeratedStateVariable("SystemUpdateID", typeof(System.UInt32), true);
                RetVal[5].AddAssociation("GetSystemUpdateID", "Id");
                RetVal[6] = new UPnPModeratedStateVariable("A_ARG_TYPE_SortCriteria", typeof(System.String), false);
                RetVal[6].AddAssociation("Browse", "SortCriteria");
                RetVal[6].AddAssociation("Search", "SortCriteria");
                RetVal[7] = new UPnPModeratedStateVariable("A_ARG_TYPE_UpdateID", typeof(System.UInt32), false);
                RetVal[7].AddAssociation("Browse", "UpdateID");
                RetVal[7].AddAssociation("Search", "UpdateID");
                ...
                RetVal[10].AddAssociation("CreateObject", "ContainerID");
                RetVal[10].AddAssociation("CreateObject", "ObjectID");
                RetVal[10].AddAssociation("CreateReference", "ContainerID");
                RetVal[10].AddAssociation("CreateReference", "ObjectID");
                RetVal[10].AddAssociation("CreateReference", "NewID");
                RetVal[10].AddAssociation("DestroyObject", "ObjectID");
                RetVal[10].AddAssociation("Search", "ContainerID");
                RetVal[10].AddAssociation("UpdateObject", "ObjectID");
                RetVal[11] = new UPnPModeratedStateVariable("ContainerUpdateIDs", typeof(System.String), true);
                RetVal[12] = new UPnPModeratedStateVariable("A_ARG_TYPE_TransferLength", typeof(System.String), false);
                RetVal[12].AddAssociation("GetTransferProgress", "TransferLength");
                RetVal[13] = new UPnPModeratedStateVariable("A_ARG_TYPE_Count", typeof(System.UInt32), false);
                RetVal[13].AddAssociation("Browse", "RequestedCount");
                RetVal[13].AddAssociation("Browse", "NumberReturned");
                RetVal[13].AddAssociation("Browse", "TotalMatches");
                RetVal[13].AddAssociation("Search", "RequestedCount");
                RetVal[13].AddAssociation("Search", "NumberReturned");
                RetVal[13].AddAssociation("Search", "TotalMatches");
                RetVal[14] = new UPnPModeratedStateVariable("A_ARG_TYPE_TransferID", typeof(System.UInt32), false);
                RetVal[14].AddAssociation("ExportResource", "TransferID");
                RetVal[14].AddAssociation("GetTransferProgress", "TransferID");
                RetVal[14].AddAssociation("ImportResource", "TransferID");
                RetVal[14].AddAssociation("StopTransferResource", "TransferID");
                RetVal[15] = new UPnPModeratedStateVariable("A_ARG_TYPE_TransferStatus", typeof(System.String), false);
                RetVal[15].AllowedStringValues = new string[4]{"COMPLETED", "ERROR", "IN_PROGRESS", "STOPPED"};
                RetVal[15].AddAssociation("GetTransferProgress", "TransferStatus");
                RetVal[16] = new UPnPModeratedStateVariable("A_ARG_TYPE_Result", typeof(System.String), false);
                RetVal[16].AddAssociation("Browse", "Result");
                RetVal[16].AddAssociation("CreateObject", "Elements");
                RetVal[16].AddAssociation("CreateObject", "Result");
                RetVal[16].AddAssociation("Search", "Result");
                RetVal[17] = new UPnPModeratedStateVariable("A_ARG_TYPE_TagValueList", typeof(System.String), false);
                RetVal[17].AddAssociation("UpdateObject", "CurrentTagValue");
                RetVal[17].AddAssociation("UpdateObject", "NewTagValue");
                RetVal[18] = new UPnPModeratedStateVariable("A_ARG_TYPE_URI", typeof(System.Uri), false);
                RetVal[18].AddAssociation("DeleteResource", "ResourceURI");
                RetVal[18].AddAssociation("ExportResource", "SourceURI");
                RetVal[18].AddAssociation("ExportResource", "DestinationURI");
                RetVal[18].AddAssociation("ImportResource", "SourceURI");
                RetVal[18].AddAssociation("ImportResource", "DestinationURI");
                RetVal[19] = new UPnPModeratedStateVariable("A_ARG_TYPE_SearchCriteria", typeof(System.String), false);
                RetVal[19].AddAssociation("Search", "SearchCriteria");

                UPnPService S = new UPnPService(1, "urn:upnp-org:serviceId:CDS_0-99", URN, true, this);

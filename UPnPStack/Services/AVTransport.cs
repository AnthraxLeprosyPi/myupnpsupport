...
namespace UPnPStack.Services
{
    ...
    public class AVTransport : IUPnPService
    {
        ...
        static public string[] Values_CurrentPlayMode
        {
            get
            {
                string[] RetVal = new string[3]{"INTRO","REPEAT_ALL","NORMAL"};
                return(RetVal);
            }
        }
        ...
        private class _DvAVTransport
        {
            ...
            protected UPnPService BuildUPnPService()
            {
                ...
                RetVal[0] = new UPnPModeratedStateVariable("PossibleRecordQualityModes", typeof(System.String), false);
                RetVal[0].AddAssociation("GetDeviceCapabilities", "RecQualityModes");
                ...
                RetVal[2] = new UPnPModeratedStateVariable("NextAVTransportURIMetaData", typeof(System.String), false);
                RetVal[2].AddAssociation("GetMediaInfo", "NextURIMetaData");
                RetVal[3] = new UPnPModeratedStateVariable("CurrentMediaDuration", typeof(System.String), false);
                RetVal[3].AddAssociation("GetMediaInfo", "MediaDuration");
                RetVal[4] = new UPnPModeratedStateVariable("TransportStatus", typeof(System.String), false);
                RetVal[4].AllowedStringValues = new string[3]{"OK", "ERROR_OCCURRED", " vendor-defined "};
                RetVal[4].AddAssociation("GetTransportInfo", "CurrentTransportStatus");
                RetVal[5] = new UPnPModeratedStateVariable("RelativeCounterPosition", typeof(System.Int32), false);
                RetVal[5].AddAssociation("GetPositionInfo", "RelCount");
                RetVal[6] = new UPnPModeratedStateVariable("A_ARG_TYPE_InstanceID", typeof(System.UInt32), false);
                RetVal[6].AddAssociation("GetCurrentTransportActions", "InstanceID");
                RetVal[6].AddAssociation("GetDeviceCapabilities", "InstanceID");
                RetVal[6].AddAssociation("GetMediaInfo", "InstanceID");
                RetVal[6].AddAssociation("GetPositionInfo", "InstanceID");
                RetVal[6].AddAssociation("GetTransportInfo", "InstanceID");
                RetVal[6].AddAssociation("GetTransportSettings", "InstanceID");
                RetVal[6].AddAssociation("Next", "InstanceID");
                RetVal[6].AddAssociation("Pause", "InstanceID");
                RetVal[6].AddAssociation("Play", "InstanceID");
                RetVal[6].AddAssociation("Previous", "InstanceID");
                RetVal[6].AddAssociation("Seek", "InstanceID");
                RetVal[6].AddAssociation("SetAVTransportURI", "InstanceID");
                RetVal[6].AddAssociation("SetPlayMode", "InstanceID");
                RetVal[6].AddAssociation("Stop", "InstanceID");
                RetVal[7] = new UPnPModeratedStateVariable("RelativeTimePosition", typeof(System.String), false);
                RetVal[7].AddAssociation("GetPositionInfo", "RelTime");
                RetVal[8] = new UPnPModeratedStateVariable("TransportState", typeof(System.String), false);
                RetVal[8].AllowedStringValues = new string[7]{"STOPPED", "PAUSED_PLAYBACK", "PAUSED_RECORDING", "PLAYING", "RECORDING", "TRANSITIONING", "NO_MEDIA_PRESENT"};
                RetVal[8].AddAssociation("GetTransportInfo", "CurrentTransportState");
                RetVal[9] = new UPnPModeratedStateVariable("CurrentPlayMode", typeof(System.String), false);
                RetVal[9].DefaultValue = UPnPService.CreateObjectInstance(typeof(System.String),"NORMAL");
                RetVal[9].AllowedStringValues = new string[3]{"NORMAL", "REPEAT_ALL", "INTRO"};
                RetVal[9].AddAssociation("GetTransportSettings", "PlayMode");
                RetVal[9].AddAssociation("SetPlayMode", "NewPlayMode");
                RetVal[10] = new UPnPModeratedStateVariable("TransportPlaySpeed", typeof(System.String), false);
                RetVal[10].AllowedStringValues = new string[2]{"1", " vendor-defined "};
                RetVal[10].AddAssociation("GetTransportInfo", "CurrentSpeed");
                RetVal[10].AddAssociation("Play", "Speed");
                RetVal[11] = new UPnPModeratedStateVariable("PossiblePlaybackStorageMedia", typeof(System.String), false);
                RetVal[11].AddAssociation("GetDeviceCapabilities", "PlayMedia");
                RetVal[12] = new UPnPModeratedStateVariable("AbsoluteTimePosition", typeof(System.String), false);
                RetVal[12].AddAssociation("GetPositionInfo", "AbsTime");
                RetVal[13] = new UPnPModeratedStateVariable("CurrentTrackURI", typeof(System.String), false);
                RetVal[13].AddAssociation("GetPositionInfo", "TrackURI");
                RetVal[14] = new UPnPModeratedStateVariable("CurrentTransportActions", typeof(System.String), false);
                RetVal[14].AddAssociation("GetCurrentTransportActions", "Actions");
                RetVal[15] = new UPnPModeratedStateVariable("NumberOfTracks", typeof(System.UInt32), false);
                RetVal[15].SetRange((System.UInt32)(0),(System.UInt32)(4294967295),null);
                RetVal[15].AddAssociation("GetMediaInfo", "NrTracks");
                RetVal[16] = new UPnPModeratedStateVariable("PossibleRecordStorageMedia", typeof(System.String), false);
                RetVal[16].AddAssociation("GetDeviceCapabilities", "RecMedia");
                RetVal[17] = new UPnPModeratedStateVariable("CurrentTrack", typeof(System.UInt32), false);
                RetVal[17].SetRange((System.UInt32)(0),(System.UInt32)(4294967295),(System.UInt32)1);
                RetVal[17].AddAssociation("GetPositionInfo", "Track");
                RetVal[18] = new UPnPModeratedStateVariable("CurrentTrackMetaData", typeof(System.String), false);
                RetVal[18].AddAssociation("GetPositionInfo", "TrackMetaData");
                RetVal[19] = new UPnPModeratedStateVariable("PlaybackStorageMedium", typeof(System.String), false);
                RetVal[19].AllowedStringValues = new string[33]{"UNKNOWN", "DV", "MINI-DV", "VHS", "W-VHS", "S-VHS", "D-VHS", "VHSC", "VIDEO8", "HI8", "CD-ROM", "CD-DA", "CD-R", "CD-RW", "VIDEO-CD", "SACD", "MD-AUDIO", "MD-PICTURE", "DVD-ROM", "DVD-VIDEO", "DVD-R", "DVD+RW", "DVD-RW", "DVD-RAM", "DVD-AUDIO", "DAT", "LD", "HDD", "MICRO-MV", "NETWORK", "NONE", "NOT_IMPLEMENTED", " vendor-defined "};
                RetVal[19].AddAssociation("GetMediaInfo", "PlayMedium");
                RetVal[20] = new UPnPModeratedStateVariable("AVTransportURIMetaData", typeof(System.String), false);
                RetVal[20].AddAssociation("GetMediaInfo", "CurrentURIMetaData");
                RetVal[20].AddAssociation("SetAVTransportURI", "CurrentURIMetaData");
                RetVal[21] = new UPnPModeratedStateVariable("A_ARG_TYPE_SeekTarget", typeof(System.String), false);
                RetVal[21].AddAssociation("Seek", "Target");
                RetVal[22] = new UPnPModeratedStateVariable("RecordStorageMedium", typeof(System.String), false);
                RetVal[22].AllowedStringValues = new string[33]{"UNKNOWN", "DV", "MINI-DV", "VHS", "W-VHS", "S-VHS", "D-VHS", "VHSC", "VIDEO8", "HI8", "CD-ROM", "CD-DA", "CD-R", "CD-RW", "VIDEO-CD", "SACD", "MD-AUDIO", "MD-PICTURE", "DVD-ROM", "DVD-VIDEO", "DVD-R", "DVD+RW", "DVD-RW", "DVD-RAM", "DVD-AUDIO", "DAT", "LD", "HDD", "MICRO-MV", "NETWORK", "NONE", "NOT_IMPLEMENTED", " vendor-defined "};
                RetVal[22].AddAssociation("GetMediaInfo", "RecordMedium");
                RetVal[23] = new UPnPModeratedStateVariable("AbsoluteCounterPosition", typeof(System.Int32), false);
                RetVal[23].AddAssociation("GetPositionInfo", "AbsCount");
                RetVal[24] = new UPnPModeratedStateVariable("LastChange", typeof(System.String), true);
                RetVal[25] = new UPnPModeratedStateVariable("AVTransportURI", typeof(System.String), false);
                RetVal[25].AddAssociation("GetMediaInfo", "CurrentURI");
                RetVal[25].AddAssociation("SetAVTransportURI", "CurrentURI");
                RetVal[26] = new UPnPModeratedStateVariable("CurrentTrackDuration", typeof(System.String), false);
                RetVal[26].AddAssociation("GetPositionInfo", "TrackDuration");
                RetVal[27] = new UPnPModeratedStateVariable("A_ARG_TYPE_SeekMode", typeof(System.String), false);
                RetVal[27].AllowedStringValues = new string[8]{"ABS_TIME", "REL_TIME", "ABS_COUNT", "REL_COUNT", "TRACK_NR", "CHANNEL_FREQ", "TAPE-INDEX", "FRAME"};
                RetVal[27].AddAssociation("Seek", "Unit");
                RetVal[28] = new UPnPModeratedStateVariable("CurrentRecordQualityMode", typeof(System.String), false);
                RetVal[28].AllowedStringValues = new string[8]{"0:EP", "1:LP", "2:SP", "0:BASIC", "1:MEDIUM", "2:HIGH", "NOT_IMPLEMENTED", " vendor-defined "};
                RetVal[28].AddAssociation("GetTransportSettings", "RecQualityMode");
                RetVal[29] = new UPnPModeratedStateVariable("RecordMediumWriteStatus", typeof(System.String), false);
                RetVal[29].AllowedStringValues = new string[5]{"WRITABLE", "PROTECTED", "NOT_WRITABLE", "UNKNOWN", "NOT_IMPLEMENTED"};
                RetVal[29].AddAssociation("GetMediaInfo", "WriteStatus");

                UPnPService S = new UPnPService(1, "urn:upnp-org:serviceId:AVT_0-99", URN, true, this);

    ...
    public class RenderingControl : IUPnPService {
        ...
        private class _DvRenderingControl {
            ...
            protected UPnPService BuildUPnPService() {
                ...
                RetVal[5].AddAssociation("GetLoudness", "CurrentLoudness");
                RetVal[5].AddAssociation("SetLoudness", "DesiredLoudness");
                RetVal[6] = new UPnPModeratedStateVariable("A_ARG_TYPE_InstanceID", typeof(System.UInt32), false);
                RetVal[6].AddAssociation("GetBlueVideoBlackLevel", "InstanceID");
                RetVal[6].AddAssociation("GetBlueVideoGain", "InstanceID");
                RetVal[6].AddAssociation("GetBrightness", "InstanceID");
                RetVal[6].AddAssociation("GetColorTemperature", "InstanceID");
                RetVal[6].AddAssociation("GetContrast", "InstanceID");
                RetVal[6].AddAssociation("GetGreenVideoBlackLevel", "InstanceID");
                RetVal[6].AddAssociation("GetGreenVideoGain", "InstanceID");
                RetVal[6].AddAssociation("GetHorizontalKeystone", "InstanceID");
                RetVal[6].AddAssociation("GetLoudness", "InstanceID");
                RetVal[6].AddAssociation("GetMute", "InstanceID");
                RetVal[6].AddAssociation("GetRedVideoBlackLevel", "InstanceID");
                RetVal[6].AddAssociation("GetRedVideoGain", "InstanceID");
                RetVal[6].AddAssociation("GetSharpness", "InstanceID");
                RetVal[6].AddAssociation("GetVerticalKeystone", "InstanceID");
                RetVal[6].AddAssociation("GetVolume", "InstanceID");
                RetVal[6].AddAssociation("GetVolumeDB", "InstanceID");
                RetVal[6].AddAssociation("GetVolumeDBRange", "InstanceID");
                RetVal[6].AddAssociation("ListPresets", "InstanceID");
                RetVal[6].AddAssociation("SelectPreset", "InstanceID");
                RetVal[6].AddAssociation("SetBlueVideoBlackLevel", "InstanceID");
                RetVal[6].AddAssociation("SetBlueVideoGain", "InstanceID");
                RetVal[6].AddAssociation("SetBrightness", "InstanceID");
                RetVal[6].AddAssociation("SetColorTemperature", "InstanceID");
                RetVal[6].AddAssociation("SetContrast", "InstanceID");
                RetVal[6].AddAssociation("SetGreenVideoBlackLevel", "InstanceID");
                RetVal[6].AddAssociation("SetGreenVideoGain", "InstanceID");
                RetVal[6].AddAssociation("SetHorizontalKeystone", "InstanceID");
                RetVal[6].AddAssociation("SetLoudness", "InstanceID");
                RetVal[6].AddAssociation("SetMute", "InstanceID");
                RetVal[6].AddAssociation("SetRedVideoBlackLevel", "InstanceID");
                RetVal[6].AddAssociation("SetRedVideoGain", "InstanceID");
                RetVal[6].AddAssociation("SetSharpness", "InstanceID");
                RetVal[6].AddAssociation("SetVerticalKeystone", "InstanceID");
                ...
                RetVal[13].AddAssociation("GetMute", "CurrentMute");
                ...
                RetVal[15].AddAssociation("GetVolumeDB", "Channel");
                RetVal[15].AddAssociation("GetVolumeDBRange", "Channel");
                RetVal[15].AddAssociation("SetLoudness", "Channel");
                RetVal[15].AddAssociation("SetMute", "Channel");
